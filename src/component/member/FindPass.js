...
// import { sendFindPassReq } from "./UserApi";

// const theme = createTheme();

// function FindPassPage() {
...
//         return;
//       }
//       const userInfo = { user_id: id, user_mail: mail, user_phone: phone };
//       console.log("[LoginPage-사용자정보]", userInfo);
//       try {
//         const data = await sendFindPassReq({user_id: id, user_mail: mail, user_phone: phone });
